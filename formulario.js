...
app.post('/crear', (req, res) => {
  ...
  try {
    ...
    if (documentacion) {
      ...
      // Hoja 2: Materiales desde el formulario
      ...
      // Hoja 3: Configuración técnica desde el formulario
...
app.listen(PORT, () => {
  ...
  console.log(url); // ESTA LÍNEA es clave para que PowerShell la capture
});
